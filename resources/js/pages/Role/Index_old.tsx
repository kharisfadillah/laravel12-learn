...
interface Role {
    ...
    name: string;
    notes: string;
    permissions?: number[]; // bisa undefined jika belum di-load
}
                        ...
                        <form onSubmit={handleEditSubmit}>
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid gap-2">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        setEditData(
                                                            'permissions',
                                                            checked
                                                                ? [...editData.permissions, perm.id]
                                                                : editData.permissions.filter((id) => id !== perm.id),
                                                        );
                                                    }}
                                                />
                                                <span>{perm.name}</span>
                                    ...
                                    {editErrors.permissions && <p className="text-sm text-red-500">{editErrors.permissions}</p>}
                                </div>
                            </div>
                            <DialogFooter>
